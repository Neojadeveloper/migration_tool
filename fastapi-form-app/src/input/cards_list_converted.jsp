...
<%!
    ...
    static final int si_loan_id = SI("ID договора", "Шартноманинг идэнтификатори", "Shartnomaning identifikatori", "ID of the contract");
    static final int si_branch_id = SI("Код БХМ", "Бхм коди", "Bxm kodi", "BXM code");
